...
5.  Semafory kształtowe nadają następujące sygnały:
    1.  **sygnał Sr 1 „Stój"**
        ...
        2.  **Nocny**: Czerwone światło na semaforze.
            ...
            ![Sr1](../images/Sr_1_dzienny_nocny.png)
...
![S 2](../img/S2_sygnal.png)

Sygnał S 2 zezwala na jazdę z największą prędkością dozwoloną dla danego pociągu na danym odcinku linii kolejowej *(szlaku, odstępie, drodze przebiegu)* i informuje, że na następnym semaforze, jeżeli semafor nadający sygnał S 2 jest z nim uzależniony, nadawany jest sygnał zezwalający na jazdę z największą dozwoloną prędkością;

### 3) sygnał S 3 „Jazda z największą dozwoloną prędkością - w przodzie są dwa odstępy blokowe wolne - albo przy następnym semaforze z prędkością nie większą niż 100 km/h"

Jedno zielone światło migające na semaforze.

![S 3](../img/S3_sygnal.png)

Sygnał S 3 zezwala na jazdę z największą prędkością dozwoloną dla danego pociągu i danego odcinka linii kolejowej *(drogi przebiegu)*. Sygnał S 3 nadawany przez:
...
### 5) sygnał S 5 „Następny semafor (wskazuje) nadaje sygnał Stój”

Jedno światło pomarańczowe ciągłe na semaforze.

![S 5](../img/S5_sygnal.png)
...
Dwa światła na semaforze w jednym pionie: dolne światło pomarańczowe ciągłe, a górne światło - zielone ciągłe.

![S 10](../img/S10_sygnal.png)
...
### 12) sygnał S 11 „Jazda z prędkością nieprzekraczającą 40 km/h, a przy następnym semaforze -- z prędkością nie przekraczającą 100 km/h"

Dwa światła na semaforze w pionie -- dolne światło pomarańczowe ciągłe, górne zielone migające.

![S 11](../img/S11_sygnal.png)
...
### 14) sygnał S 12 "Jazda z prędkością nieprzekraczającą 40 km/h, a przy następnym semaforze - z prędkością nie przekraczającą 40 lub 60 km/h"

Dwa światła na semaforze w pionie - dolne światło pomarańczowe ciągłe, górne światło pomarańczowe migające.

![S 12](../img/S12_sygnal.png)
...
### 15) sygnał S 12a "Jazda z prędkością nieprzekraczającą 60 km/h, a przy następnym semaforze - z prędkością zmniejszoną do 40 lub 60 km/h"

Dwa światła na semaforze w pionie - dolne światło pomarańczowe ciągłe, a pod nim świetlny pas pomarańczowy poziomy, górne światło pomarańczowe migające.

![S 12a](../img/S12a_sygnal.png)
...
### 16) sygnał S 13 „Jazda z prędkością nieprzekraczającą 40 km/h, a przy następnym semaforze - Stój"

Dwa światła pomarańczowe ciągłe na semaforze w jednym pionie.

![S 13](../img/S13_sygnal.png)
